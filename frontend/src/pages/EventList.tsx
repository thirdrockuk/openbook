...
export default function EventList() {
  ...
  if (!events?.length) {
    return (
      ...
      <section className="rounded-xl border border-sky-100 bg-gradient-to-r from-sky-50 to-white p-8">
  ...
  return (
    <div className="space-y-8">
      <section className="rounded-xl border border-sky-100 bg-gradient-to-r from-sky-50 to-white p-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-sky-600">OpenBook</p>
